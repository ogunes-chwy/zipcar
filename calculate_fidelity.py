...
def calculate_carrier_coverage(df, group_cols, value_col, func, denom_cols, 
    ...
    """
    coverage = hp.calculate_package_distribution_by_groups(
...
def calculate_fc_charges(df, group_cols, value_col, func, denom_cols, 
    ...
    """
    charges = hp.calculate_package_distribution_by_groups(
        df, group_cols=group_cols, value_col=value_col, 
        f=func, denom_cols=denom_cols
    )
...
def main():
    ...
    df_sim_wms_proxy = hp.apply_wms_proxy(df_sim, WMS_PROXY_QUERY)
    ...
    return {
        'carrier_coverage_before_wms_proxy': carrier_coverage_comp_before,
        'carrier_coverage_after_wms_proxy': carrier_coverage_comp_after,
        'fc_region_charge_comp': fc_region_charge_comp,
        'fc_charge_comp': fc_charge_comp
    }
